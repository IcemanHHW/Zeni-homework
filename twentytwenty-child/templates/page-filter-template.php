        ...
        <form role="search" method="get" id="filterform" action="/page-filter-query">
            <div>
                ...
                <select name="month_from">
                    ...
                    <option value="3" <?php if ($_GET['month_from'] == '3') echo 'selected="selected"'; ?>>March
                    </option>
                    <option value="4" <?php if ($_GET['month_from'] == '4') echo 'selected="selected"'; ?>>April
                    </option>
                    ...
                    <option value="10" <?php if ($_GET['month_from'] == '10') echo 'selected="selected"'; ?>>Oct
                    </option>
                    <option value="11" <?php if ($_GET['month_from'] == '11') echo 'selected="selected"'; ?>>Nov
                    </option>
                    <option value="12" <?php if ($_GET['month_from'] == '12') echo 'selected="selected"'; ?>>Dec
                    </option>
                </select>
                <select name="year_from">
                    <option value="2017" <?php if ($_GET['year_from'] == '2017') echo 'selected="selected"'; ?>>2017
                    </option>
                    <option value="2018" <?php if ($_GET['year_from'] == '2018') echo 'selected="selected"'; ?>>2018
                    </option>
                    <option value="2019" <?php if ($_GET['year_from'] == '2019') echo 'selected="selected"'; ?>>2019
                    </option>
                    <option value="2020" <?php if ($_GET['year_from'] == '2020') echo 'selected="selected"'; ?>>2020
                    </option>
                </select>
            </div>
            <br><br>
            <div>
                ...
                <select name="year_to">
                    <option value="2017" <?php if ($_GET['year_to'] == '2017') echo 'selected="selected"'; ?>>2017
                    </option>
                    <option value="2018" <?php if ($_GET['year_to'] == '2018') echo 'selected="selected"'; ?>>2018
                    </option>
                    <option value="2019" <?php if ($_GET['year_to'] == '2019') echo 'selected="selected"'; ?>>2019
                    </option>
                    <option value="2020" <?php if ($_GET['year_to'] == '2020') echo 'selected="selected"'; ?>>2020
                    </option>
                </select>
            </div>
            <br><br>
